...
document.getElementById('n-contact').addEventListener('click', function () {
  var pageFifteen = document.getElementById('page15');
  if (pageFifteen.style.display === 'none') {
    pageFifteen.style.display = 'block';
  } else {
